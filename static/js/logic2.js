...
//add a control layer to basemap and overlay
L.control.layers(baseMaps, overlays).addTo(myMap);

//dictate the stying for all of the earthquake points on the map
...
//fillColor of the earthquake based on earthquake depth
function chooseColor(depth) {
    if (depth <= 10) return "green";
    else if (depth > 10 & depth <= 25) return "grey";
